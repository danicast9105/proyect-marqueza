class Cotizaciones:
    ...
    def __init__(self, COT_ID, COT_UUID, COT_PRO_CODIGO, COT_PRO_NOMBRE, COT_CANTIDAD, COT_PRECIO, COT_TOTAL_PAGAR, COT_USUA_ID, COT_CLI_ID):
        self.COT_ID = COT_ID
        self.COT_UUID = COT_UUID
        self.COT_PRO_CODIGO = COT_PRO_CODIGO
        self.COT_PRO_NOMBRE = COT_PRO_NOMBRE
        self.COT_CANTIDAD = COT_CANTIDAD
        self.COT_PRECIO = COT_PRECIO
    ...
    def to_dic(self):
        return {
            ...
            "cantidad": self.COT_CANTIDAD,
            "precio": self.COT_PRECIO,
